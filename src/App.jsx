    ...
    <div className="app-shell">
      <header className="site-header">
        ...
        <nav className={`site-nav ${menuOpen ? 'is-open' : ''}`} aria-label="Navegación principal">
          ...
          <div className="user-menu"><span className="user-name">{profile?.display_name || user.email}</span><button className="button secondary small" type="button" onClick={handleSignOut}>Salir</button></div>
        </nav>
      </header>
      <main>
